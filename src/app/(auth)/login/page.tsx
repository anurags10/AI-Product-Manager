    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-zinc-50 dark:bg-zinc-950 selection:bg-indigo-500/30 font-sans">
      ...
      <div className="hidden lg:flex flex-col justify-between px-16 py-20 relative overflow-hidden bg-zinc-900 border-r border-zinc-800">
        ...
        <div className="relative z-10">
          ...
          >
            Welcome back to your entire product brain.
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Transform raw requirements into execution-ready 3-month engineering
            roadmaps in seconds.
          </motion.p>
          ...
          >
            <div className="flex items-center gap-3 text-sm text-zinc-300">
              ...
              <span className="font-medium">AI-powered PRD analysis</span>
            </div>
            <div className="flex items-center gap-3 text-sm text-zinc-300">
            ...
            <div className="flex items-center gap-3 text-sm text-zinc-300">
              ...
              <span className="font-medium">
                Instant iteration and tracking
              </span>
            </div>
          </motion.div>
        </div>
      ...
      <div className="flex items-center justify-center px-6 py-12 relative overflow-hidden">
        ...
        >
          ...
          <div className="space-y-5">
            ...
            <Button
              className="w-full h-11 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white shadow-md cursor-pointer font-medium"
              onClick={handleLogin}
              disabled={loading}
            >
